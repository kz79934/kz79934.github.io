...
if ( ! empty( $tabs ) ) :
	...
	<div class="tab-container wootabs">
		<ul class="nav nav-tabs<?php echo esc_attr($limit_content_width); ?> single-h-padding">
		...
		<?php
			...
			foreach ( $tabs as $key => $tab ) :
				...
				<?php } else { ?>
				<div class="tab-pane fade<?php echo $limit_content_width; ?> single-h-padding<?php if ($index === 0) echo ' active in'; ?>" id="tab-<?php echo esc_attr( $key ) ?>-<?php echo esc_attr(get_the_id()); ?>">
